...
function checkAnswer() {
    ...
    if (isCorrect) {
        ...
        alert(`Awww.... you answered ${userAnswer}. The correct answer was ${calcualtedAnswer[0]}!`);
...
function displaySubtractQuestion(operand1, operand2) {
    ...
    // document.getElementById('operand1').textContent = operand1;
    // document.getElementById('operand2').textContent = operand2; // this would work in case of my solution above
    document.getElementById('operator').textContent = '-';
}
